  ...
  return (
    <Wrapper>
      ...
      <SocialMedia>
        ...
        <a href={'https://github.com/gybubest'} target="_blank"><SMIcons src={github} alt={'Github'} title={'Checkout my Github'}></SMIcons></a>
        <a href={'https://www.linkedin.com/in/bestyugao/'} target="_blank"><SMIcons src={linkedIn} alt={'LinkedIn'} title={'Connect on LinkedIn'}></SMIcons></a>
        <a href={'https://goo.gl/maps/LSkREq3DofbbDZ8o9'} target="_blank"><SMIcons src={location} alt={'Location'} title={'Toronto, Canada'} lastIcon></SMIcons></a>
      </SocialMedia>
    </Wrapper>
  );
}
